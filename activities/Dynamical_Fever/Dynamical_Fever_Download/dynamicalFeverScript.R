...
## Paris. Typical outbreaks produce similar patterns of cases in the two
## populations, and the outbreaks always occur simultaneously. DF became a reportable
## disease in Paris in 2017, and the Ministry of Health has enlisted your help
## to understand the data they have collected since that time.
##
## In 2017 and 2018 the outbreaks looked pretty similar. First, let's look at how the epidemics
## in dogs and people progressed in 2017:
...
## In 2019, there was only one case in dogs and one in humans, but in 2020, another large
...
## Based on the data from 2017-2020, what have you learned about DF?  What factors might determine the
...
##
## A veterinary vaccine against DF had been approved for use in dogs in mid-2019, but since there was
## not a problem that year, the Ministry of Health did not promote it's use. Following the the disease's
## resurgence in 2020, however, information on the vaccine was sent to veterinarians and pet owners
## in an effort to encourage vaccine uptake. By the beginning of 2021, 40 percent of the dog population
## in Paris had been vaccinated.
##
## In 2021, the number of DF cases was substantially lower than in any year other than 2019, with only 34
...
## gotten sick in 2020, and by the beginning of 2021, 50 percent of the dog population in Paris had
## been vaccinated.
##
## As it turned out, the 2022 data did not clarify things for the Minister, and the debate within the department
## only grew more heated, with each side claiming that the 2022 data supported their argument:

plot.cases(data.2022)            # Plot epidemic curve for 2022

## In the first 17 weeks of 2022, 109 dogs and 213 people contracted DF.
##
...
##
## Luckily for the Minister of Health, the approval of a human vaccine against DF in mid-2022
...
## By the beginning of 2023, 50 percent of the people in Paris had been vaccinated, though dog vaccine
## uptake fell to 20 percent.
##
## Although the 2023 season got off to a slow start, the Minister was in for a surprise when the outbreak
## picked up later in the season. In the end, the 2023 outbreak was the worst one for years, with 480 canine
...
## time for the 2024 season as possible. By the beginning of the year, 80 percent of the people in Paris
...
## see so many canine cases in Paris in 2024:

plot.cases(data.2024)            # Plot epidemic curve for 2024

## In fact, there were more cases of DF in dogs in 2024 than in any year on record, with 812 canine cases,
...
## of the observed data? What would you advise the AD to do in order to prepare for the 2025 DF season?
##
## PART 4 - Moving forward
##
## Decide on target levels of vaccination for dogs and people in 2025, keeping in mind that it is unlikely that
## you will be able to achieve 100 percent vaccination of either population. Enter these values below, replacing
## XXX and YYY respectively with a number between 0 and 100.

VaxPct.Dogs <- 50#XXX             # Target vaccination level for DOG population
VaxPct.Humans <- 30#YYY            # Target vaccination level for HUMAN population

## We'll now run the model once to see an example of what might happen if these levels of vaccination were
## achieved in 2025:

target.2025 <- run.example(VaxPct.Dogs,VaxPct.Humans)

## Plot the cases through time to see what happened:

plot.cases(target.2025)
